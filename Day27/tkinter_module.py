...
# Day27 : GUI with Tkinter / Function Arguments
...
my_label.pack()     # pack() method places component(e.g., Label) in the screen with center-aligned
...
print(text.get("1.0", END)) # 1.0 = 1st line 0th index of char
text.pack()
